...
export default function LoginPage() {
  ...
  return (
    <div className="flex-1 flex items-center justify-center p-4 relative min-h-[calc(100vh-64px)]">
      {/* Background Effects */}
      ...
      >
        <div className="glass p-8 rounded-2xl border-white/10 relative overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {!isLogin && (
                ...
                >
                  ...
                  <input
                    ...
                    className="w-full bg-surface border border-white/10 rounded-lg px-4 py-2.5 text-sm text-white focus:outline-none focus:border-primary/50 transition-colors"
            ...
            <div className="pb-2">
              <label className="block text-xs font-medium text-muted mb-1.5 uppercase tracking-wider">
                {isLogin ? "Password" : "Set Up New Password"}
              </label>
              <input
                type="password"
                required
          ...
          <div className="mt-6 pt-6 border-t border-white/10 text-center">
            <Button
              type="button"
              variant="outline"
              className="w-full text-sm font-bold flex items-center justify-center gap-2 mb-6 hover:bg-white/5"
            ...
            <p className="text-sm text-muted">
              ...
              <button
                ...
                className="ml-2 text-primary hover:text-white transition-colors font-medium focus:outline-none"
              >
