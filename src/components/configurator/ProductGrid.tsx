        ...
        {products.map((product) => {
          ...
          return (
            ...
            >
              ...
              {/* Price & Action */}
              <div className="flex flex-col items-end gap-2 w-full sm:w-56 relative z-10 shrink-0 sm:pl-6 sm:border-l sm:border-white/10">
                {/* Price */}
                <p className={`text-xl font-black tracking-tight whitespace-nowrap drop-shadow-[0_0_8px_rgba(255,255,255,0.1)] self-start sm:self-end ${isSelected ? "text-primary" : "text-white"}`}>
                ...
                <div className="flex items-center gap-2 w-full sm:justify-end">
                  ...
                  {product.amazonUrl && (
                    <a
                      ...
                      title="Buy on Amazon"
                      className="shrink-0 flex items-center gap-1.5 px-3 py-1.5 rounded-md text-xs font-bold tracking-wide border transition-all duration-200
                        border-[#FF9900]/40 text-[#FF9900] bg-[#FF9900]/5
                        hover:bg-[#FF9900]/15 hover:border-[#FF9900]/70 hover:shadow-[0_0_12px_rgba(255,153,0,0.25)]
                        active:scale-95"
                    >
